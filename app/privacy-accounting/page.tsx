        ...
        <div className="min-h-screen bg-[#1B1464] text-white p-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8">
                    <p className="text-gray-300 mb-6">Last updated: March 04, 2025</p>
                    ...
                    <div className="prose prose-invert max-w-none">
                        ...
                        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and
                            ...
                            <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noreferrer">Privacy Policy Generator</a>.</p>
                        <h2 className="mt-8">Interpretation and Definitions</h2>
                        <h3 className="mt-8">Interpretation</h3>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Application</strong> refers to Accounting CPA Quiz Game, the software program provided by the Company.</p>
                            </li>
                            <li>
                                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                                    &quot;Our&quot; in this Agreement) refers to Sixty-Five Group Pty Ltd.</p>
                            </li>
                            <li>
                        ...
                        <h2 className="mt-8">Collecting and Using Your Personal Data</h2>
                        <h3 className="mt-8">Types of Data Collected</h3>
                        <h4 className="mt-8">Personal Data</h4>
                        ...
                        <h3 className="mt-8">Use of Your Personal Data</h3>
                        ...
                        <h3 className="mt-8">Retention of Your Personal Data</h3>
                        ...
                        <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a
                            shorter period of time, except when this data iss used to strengthen the security or to improve the functionality of
                            Our Service, or We are legally obligated to retain this data for longer time periods.</p>
                        <h3 className="mt-8">Transfer of Your Personal Data</h3>
                        ...
                        <h3 className="mt-8">Delete Your Personal Data</h3>
                        ...
                        <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis
                            to do so.</p>
                        <h3 className="mt-8">Disclosure of Your Personal Data</h3>
                        <h4 className="mt-8">Business Transactions</h4>
                        ...
                        <h4 className="mt-8">Law enforcement</h4>
                        ...
                        <h4 className="mt-8">Other legal requirements</h4>
                        ...
                        <h3 className="mt-8">Security of Your Personal Data</h3>
                        ...
                        <h2 className="mt-8">Children&apos;s Privacy</h2>
                        ...
                        <h2 className="mt-8">Links to Other Websites</h2>
                        ...
                        <ul>
                            <li>By email: info@examquiz.co.za</li>
                        </ul>
                    </div>
                </div>
            </div>
